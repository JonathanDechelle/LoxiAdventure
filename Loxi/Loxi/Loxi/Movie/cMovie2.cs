...
namespace Loxi
{
    ...
    {
        Animation Fou = new Animation(RessourcesLoxi.FouAnime, 60, 0.5f,3f, true);
        Animation DragInNiv2 = new Animation(RessourcesLoxi.DragInNiv2, 110, 0.25f, 2, false);
        AnimationPlayer AnimationPlayer = new AnimationPlayer();
        AnimationPlayer AnimationPlayer2 = new AnimationPlayer();
        int Compteur=0;
        string Parole="";
        Vector2 ParolePosition = new Vector2(30, 130);
        Rectangle BullePosition = new Rectangle(150, 30, (int)(RessourcesLoxi.BulleParole.Width * 1.5), (int)(RessourcesLoxi.BulleParole.Height * 1.5));
       //Position Bulle Mechant BullePosition = new Rectangle(580, 55, (int)(Ressources.BulleParole.Width * 1.5), (int)(Ressources.BulleParole.Height * 1.5));
            ...
            : base(serviceProvider,graphics)
        {
         ...
         {
             MediaPlayer.Play(RessourcesLoxi.SongCinematique2);
         }
         ...
         public override void Update(GameTime gameTime)
         {
             switch (Compteur)
             {
                 ...
                 case 1: Parole = "Mais comment\navez vous fait\n pour rentrer !?\noui c'est mon plan\n et personne ne\n pourra l' \n   empecher !!!!!";// \n je te laisse une chance de partir";
                     ...
                     BullePosition = new Rectangle(580, 55, (int)(RessourcesLoxi.BulleParole.Width * 1.5), (int)(RessourcesLoxi.BulleParole.Height * 1.5));
                 ...
                 case 3: Parole = "JE NE TE\nLAISSERAI PAS\nFAiRE !!!!!!!!\nJE SUIS EN \nVACANCES \n J'AIMERAIS EN\n  PROFITER ENCORE\n            !!!!!!";
                     ...
                     BullePosition = new Rectangle(150, 30, (int)(RessourcesLoxi.BulleParole.Width * 1.5), (int)(RessourcesLoxi.BulleParole.Height * 1.5));
                     break;
         ...
         {
             g.Draw(RessourcesLoxi.Machine2, new Rectangle(500, -10, 400, 400), Color.White);
              g.Draw(RessourcesLoxi.Machine, new Rectangle(400, 50, 400, 400), Color.White);
             ...
             if (Compteur == 5)
             {
                 ...
                 if (AnimationPlayer.m_FrameIndex == 13)
                 {
                     ...
                     g.DrawString(RessourcesLoxi.Texte2, "Appuyer sur espace", new Vector2(ParolePosition.X, ParolePosition.Y + 300), CouleurParole);
                     AnimationPlayer2.Draw(gametime, g, new Vector2(700, 420), SpriteEffects.FlipHorizontally);
                 }
             }
             else
             {
                 g.Draw(RessourcesLoxi.Donald, new Vector2(200, 200), Color.White);
                 g.Draw(RessourcesLoxi.BulleParole, BullePosition, null, Color.White, 20, new Vector2(), SpriteEffects.None, 0);
